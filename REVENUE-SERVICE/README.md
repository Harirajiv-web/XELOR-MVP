...
The configuration you quote becomes the machine you service: enquiry intake, cost sheets and margin approval, then warranty, spares and field visits.
...
Equivalent from the workspace root: `./build-local.ps1 -Phase 9`, then `./start-local.ps1 -Phase 9`.
