...
Machine signals, maintenance and energy on one asset register: operator jobs, OEE and downtime, preventive schedules, technician work orders and consumption by line.

| | |
|---|---|
| Technical profile | 5 |
| Web | http://localhost:4401 |
...
Equivalent from the workspace root: `./build-local.ps1 -Phase 5`, then `./start-local.ps1 -Phase 5`.
