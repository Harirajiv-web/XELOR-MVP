...
-- =============================================================================
-- Shifts (§20.2). 3S runs A/B/C rotating on the shop floor plus a General shift.
-- =============================================================================
...
INSERT INTO salary_structure (id, tenant_id, created_by, updated_by, code, name, effective_from, status) VALUES
 ('0192a8c0-0025-7000-8000-000000000130','0192a8c0-0000-7000-8000-000000000001','0192a8c0-0000-7000-8000-0000000000ff','0192a8c0-0000-7000-8000-0000000000ff','3S-O2','TPC Operator O2',DATE '2026-04-01','active')
ON CONFLICT (id) DO NOTHING;
...
INSERT INTO employee (id, tenant_id, created_by, updated_by, emp_code, first_name, last_name, gender,
 ...
 ('0192a8c0-0025-7000-8000-000000000201','0192a8c0-0000-7000-8000-000000000001','0192a8c0-0000-7000-8000-0000000000ff','0192a8c0-0000-7000-8000-0000000000ff','3S-0001','Rajesh','Kulkarni','male','permanent',NULL,DATE '2016-06-01','active','MH',NULL,'capped_at_15000','0192a8c0-0002-7000-8000-000000000001','Operations','Plant Head','CC-OPS','0192a8c0-0025-7000-8000-000000000103','v1.0'),
 ('0192a8c0-0025-7000-8000-000000000202','0192a8c0-0000-7000-8000-000000000001','0192a8c0-0000-7000-8000-0000000000ff','0192a8c0-0000-7000-8000-0000000000ff','3S-0002','Meera','Iyer','female','permanent',NULL,DATE '2018-04-02','active','MH',NULL,'capped_at_15000','0192a8c0-0002-7000-8000-000000000001','Finance','Finance Controller','CC-FIN','0192a8c0-0025-7000-8000-000000000103','v1.0'),
 ('0192a8c0-0025-7000-8000-000000000203','0192a8c0-0000-7000-8000-000000000001','0192a8c0-0000-7000-8000-0000000000ff','0192a8c0-0000-7000-8000-0000000000ff','3S-0003','Priya','Deshmukh','female','permanent',NULL,DATE '2019-07-15','active','MH',NULL,'capped_at_15000','0192a8c0-0002-7000-8000-000000000001','HR','HR Manager','CC-HR','0192a8c0-0025-7000-8000-000000000103','v1.0'),
 ('0192a8c0-0025-7000-8000-000000000204','0192a8c0-0000-7000-8000-000000000001','0192a8c0-0000-7000-8000-0000000000ff','0192a8c0-0000-7000-8000-0000000000ff','3S-0004','Kavita','Rao','female','permanent',NULL,DATE '2020-01-06','active','MH',NULL,'capped_at_15000','0192a8c0-0002-7000-8000-000000000001','Quality','Quality Engineer','CC-QC','0192a8c0-0025-7000-8000-000000000103','v1.0'),
 ('0192a8c0-0025-7000-8000-000000000205','0192a8c0-0000-7000-8000-000000000001','0192a8c0-0000-7000-8000-0000000000ff','0192a8c0-0000-7000-8000-0000000000ff','3S-0005','Deepa','Menon','female','permanent',NULL,DATE '2020-09-01','active','MH',NULL,'capped_at_15000','0192a8c0-0002-7000-8000-000000000001','Purchase','Purchase Officer','CC-PUR','0192a8c0-0025-7000-8000-000000000103','v1.0'),
 ('0192a8c0-0025-7000-8000-000000000206','0192a8c0-0000-7000-8000-000000000001','0192a8c0-0000-7000-8000-0000000000ff','0192a8c0-0000-7000-8000-0000000000ff','3S-0006','Arun','Nair','male','permanent',NULL,DATE '2021-02-15','active','MH',NULL,'capped_at_15000','0192a8c0-0002-7000-8000-000000000001','Stores','Stores In-charge','CC-STR','0192a8c0-0025-7000-8000-000000000103','v1.0'),
 ('0192a8c0-0025-7000-8000-000000000207','0192a8c0-0000-7000-8000-000000000001','0192a8c0-0000-7000-8000-0000000000ff','0192a8c0-0000-7000-8000-0000000000ff','3S-0007','Imran','Shaikh','male','permanent',NULL,DATE '2021-08-09','active','MH',NULL,'capped_at_15000','0192a8c0-0002-7000-8000-000000000001','Maintenance','Maintenance Technician','CC-MNT','0192a8c0-0025-7000-8000-000000000101','v1.0'),
 ('0192a8c0-0025-7000-8000-000000000208','0192a8c0-0000-7000-8000-000000000001','0192a8c0-0000-7000-8000-0000000000ff','0192a8c0-0000-7000-8000-0000000000ff','3S-0008','Sanjay','Patil','male','permanent',NULL,DATE '2021-06-01','active','MH',NULL,'capped_at_15000','0192a8c0-0002-7000-8000-000000000001','Production','CNC Operator','CC-PRD','0192a8c0-0025-7000-8000-000000000100','v1.0'),
 -- Vikram is FIXED-TERM: gratuity vests at one year (01-Apr-2027), not five.
 ('0192a8c0-0025-7000-8000-000000000209','0192a8c0-0000-7000-8000-000000000001','0192a8c0-0000-7000-8000-0000000000ff','0192a8c0-0000-7000-8000-0000000000ff','3S-0009','Vikram','Jadhav','male','fixed_term',DATE '2027-03-31',DATE '2026-04-01','active','MH',NULL,'capped_at_15000','0192a8c0-0002-7000-8000-000000000001','Production','CNC Operator','CC-PRD','0192a8c0-0025-7000-8000-000000000101','v1.0'),
 -- Lakshmi is at the Coimbatore plant: Tamil Nadu PT, half-yearly, per municipality.
 ('0192a8c0-0025-7000-8000-000000000210','0192a8c0-0000-7000-8000-000000000001','0192a8c0-0000-7000-8000-0000000000ff','0192a8c0-0000-7000-8000-0000000000ff','3S-0010','Lakshmi','Subramanian','female','permanent',NULL,DATE '2019-11-04','active','TN','Coimbatore','capped_at_15000','0192a8c0-0002-7000-8000-000000000002','Production','Machine Operator','CC-PRD','0192a8c0-0025-7000-8000-000000000100','v1.0')
ON CONFLICT (id) DO NOTHING;
