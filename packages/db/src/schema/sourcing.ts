...
export const sourcingSupplierQuote = pgTable(
  "sourcing_supplier_quote",
  {
    ...
    nonCreditableTax: numeric("non_creditable_tax", { precision: 18, scale: 2 }).notNull().default("0"),
  ...
  (t) => [
    unique("uq_squote_rfq_vendor_rev").on(t.tenantId, t.rfqId, t.vendorId, t.revisionNo),
