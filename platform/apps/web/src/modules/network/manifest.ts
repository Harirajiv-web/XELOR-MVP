...
export const networkManifest: ModuleManifest = {
  ...
  nav: [
    {
      label: "Tenders", path: "tenders", permission: "purchase.rfq.read", icon: "Files",
      description: "Group materials into a tender, publish requests, review supplier offers and record one approved award for each line. Awards create draft purchase orders through the purchase workflow.",
    },
    {
      label: "Suppliers",
      path: "suppliers",
  ...
  screens: {
    tenders: () => import("./screens/tenders"),
