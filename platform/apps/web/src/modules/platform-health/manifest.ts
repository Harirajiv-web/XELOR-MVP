...
export const platformHealthManifest: ModuleManifest = {
  ...
  summary:
    "ACHILES privately checks whether the platform's web application, API, database and supporting runtime are responding, then keeps a tenant-fenced history for authorised internal operators.",
  department: "ACHILES",
  icon: "Activity",
  licenceKey: "aiops",
