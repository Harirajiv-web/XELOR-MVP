 ...
 * needs no training.
 *
 * It DOES use the theme tokens — unlike the supplier's public page, this is an internal
 * screen somebody stares at for eight hours, and it must follow their light/dark choice.
 */
const TABS = [
      ...
      <header className="sticky top-0 z-20 border-b border-[var(--border)] bg-[var(--chrome)]">
        <div className="mx-auto flex max-w-[100rem] flex-wrap items-center gap-x-6 gap-y-2 px-5 py-3">
          <Link href="/desk" className="flex items-center gap-2.5">
            <span className="grid h-8 w-8 place-items-center rounded-lg bg-[var(--accent)] text-[13px] font-bold text-[var(--text-on-fill)]">
              SD
            </span>
