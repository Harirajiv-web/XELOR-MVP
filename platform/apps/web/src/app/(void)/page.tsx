...
export default function VoidRoute(): React.JSX.Element {
  ...
  useEffect(() => { router.replace(PRODUCT_PROFILE.home); }, [router]);
  return <div className="grid min-h-dvh place-items-center bg-[var(--bg)] text-sm text-[var(--text-muted)]">Opening your workspace…</div>;
}
