 ...
 *
 * Every assertion below ("Username or email", "Enter workspace", "real Keycloak access") is
...
test("one Enter workspace click works repeatedly in the same browser tab", async ({ page }) => {
