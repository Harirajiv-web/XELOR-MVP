 ...
 */
const API_ORIGIN = process.env.NEXT_PUBLIC_API_ORIGIN ?? "http://127.0.0.1:4300";

const nextConfig: NextConfig = {
  reactStrictMode: true,
  distDir: process.env.NEXT_BUILD_DIR ?? `.next/phase-${process.env.NEXT_PUBLIC_PRODUCT_PHASE ?? "4"}`,
    ...
    return [
      {
        ...
        headers: [
          ...
          // Allow user-initiated document capture/voice on this origin only.
