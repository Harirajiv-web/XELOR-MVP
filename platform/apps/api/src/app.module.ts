...
import { ProductProfileGuard } from "./common/product-profile.guard.js";
...
import { ConnectivityModule } from "./modules/connectivity/connectivity.module.js";
...
@Module({
  ...
  providers: [{ provide: APP_GUARD, useClass: ProductProfileGuard }, { provide: APP_GUARD, useClass: PermissionGuard }],
})
