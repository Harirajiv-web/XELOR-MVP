...
export const PERMISSION_REGISTRY = [
  ...
  },
  {
    ...
    docType: "network_supplier",
    description: "Read the supplier network and the messages sent to it.",
    privileged: false,
  },
  {
    permission: "purchase.network.manage",
    docType: "network_supplier",
    description: "Add and maintain suppliers on the network.",
    privileged: false,
  },
  {
    permission: "purchase.network.broadcast",
    docType: "rfq_broadcast",
    description: "Publish a request for quotation to the network's suppliers.",
    privileged: false,
  },
  {
