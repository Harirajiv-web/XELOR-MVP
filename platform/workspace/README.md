...
> Historical workspace snapshot, retained for context. The two-product layout, ports,
> databases and launcher commands below have been superseded. Use the current
> [workspace guide](../../README.md), [four-product map](../../deliverables/Four-Phase-Product.md)
> and [consolidation decision](../../docs/00-governance/02-four-product-consolidation.md).
> The maintained implementation is `platform/` at the repository root; this nested
> `workspace/` directory contains earlier documentation and deliverables.
