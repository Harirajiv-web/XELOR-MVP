...
The people work around the software: discovery and data migration, connectors and data operations, on-site commissioning evidence and ongoing support.

| | |
|---|---|
| Technical profile | 10 |
| Web | http://localhost:4901 |
...
Equivalent from the workspace root: `./build-local.ps1 -Phase 10`, then `./start-local.ps1 -Phase 10`.
