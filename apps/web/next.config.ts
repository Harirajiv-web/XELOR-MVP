...
const nextConfig: NextConfig = {
  ...
  // Lets local reviewers build a second revision without overwriting the `.next` directory
  // used by an already-running demo. Production keeps Next's default unless explicitly set.
