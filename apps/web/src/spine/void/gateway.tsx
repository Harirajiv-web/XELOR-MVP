...
export function Gateway(): React.JSX.Element {
   ...
   * reveals the catalogue-backed seven-agent topology. Starting in `onyx` skipped that
    ...
    >
      ...
      */}
      ...
      {/*
        ...
        seven-agent topology out loud, which takes considerably longer than half a minute.
