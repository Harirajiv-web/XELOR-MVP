...
const focusedDemoScenarios: DemoScenario[] = [
  {
    ...
    steps: [
      { phase: "Trigger", title: "Open the decision, not a module", path: "/agentos/commander", body: "The live commander joins customer, planning, quality, maintenance and financial facts around the Northstar commitment. Connected value is labelled as exposure—not predicted loss.", presenterLine: "A conventional ERP shows six records. XELOR recognizes that they are one decision.", agents: ["ONYX", "MICA", "SPAR", "AXLE", "KILN", "RASP", "HEXA"] },
